...
viewGallows : Svg msg
viewGallows =
    svg [ id "drawing", xHeight "155mm", width "130mm", version "1.1", viewBox "0 0 460.9899 548.03535" ]
        [
            g [ transform "translate(-27.2 -220)"]
              ...
              , Svg.path [ id "brace"
                         ...
                         , d ("m264 261c-8.46 10.1-15 23.2-26.4 28.4-4.63 8.07-10.4 " ++
                              ...
                              "18.2-27.4 9.05-4.29 15-16.7 23-24.6 7.56-7.78 8.4-25.1 26.4 1.5z")
                         ] []
              , Svg.path [ id "topbar"
                         , Svg.Attributes.style "fill: #c27207; stroke: #c27207;"
